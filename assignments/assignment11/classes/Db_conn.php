...
class DatabaseConn {	
  ...
  public function dbOpen(){
    ...
    try {
      ...
      $dbHost = 'localhost';
      $dbName = 'mrakhymbekova';//this will be your WCC username
      $dbUsr = 'mrakhymbekova';//this will be your WCC username
      $dbPass = '42Cd9CHO9uDnPvL';//this will be the password found in the video.
